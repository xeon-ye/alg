...
public class LineData {
    ...
    private List<LineOneStepData> lineOneStepDataList;
    ...
    public List<LineOneStepData> getLineOneStepDataList() {
        return lineOneStepDataList;
    }

    public void setLineOneStepDataList(List<LineOneStepData> lineOneStepDataList) {
        this.lineOneStepDataList = lineOneStepDataList;
    }
}
