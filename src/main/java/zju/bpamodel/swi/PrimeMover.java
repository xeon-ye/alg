...
public class PrimeMover implements Serializable {
    ...
    public void parseString(String content, String charset) throws UnsupportedEncodingException {
        ...
        if (type == 'G') {
            maxPower = BpaFileRwUtil.parseDouble(new String(BpaFileRwUtil.getTarget(src, 16, 22)).trim());
            r = BpaFileRwUtil.parseDouble(new String(BpaFileRwUtil.getTarget(src, 22, 27)).trim());
            tg = BpaFileRwUtil.parseDouble(new String(BpaFileRwUtil.getTarget(src, 27, 32)).trim());
            tp = BpaFileRwUtil.parseDouble(new String(BpaFileRwUtil.getTarget(src, 32, 37)).trim());
            ...
            dd = BpaFileRwUtil.parseDouble(new String(BpaFileRwUtil.getTarget(src, 57, 62)).trim());
    ...
    public String toString() {
        ...
        strLine += BpaFileRwUtil.getFormatStr(maxPower, "6.2");//the bpa manual is 6.1
        strLine += BpaFileRwUtil.getFormatStr(r, "5.4");//the bpa manual is 5.3
        strLine += BpaFileRwUtil.getFormatStr(tg, "5.4");//the bpa manual is 5.3
        strLine += BpaFileRwUtil.getFormatStr(tp, "5.4");//the bpa manual is 5.3
        ...
        strLine += BpaFileRwUtil.getFormatStr(dd, "5.4");//the bpa manual is 5.3
