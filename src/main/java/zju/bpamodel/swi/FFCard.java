 ...
 * Date: 19-3-18
 */
public class FFCard implements Serializable {
    private String type = "FF";//FF
    private double t;
    private double dt;
    private double endT;
    private double dtc;
    ...
    public static FFCard createFF(String content) {
        FFCard ffCard = new FFCard();
        ffCard.parseString(content);
        return ffCard;
    }
