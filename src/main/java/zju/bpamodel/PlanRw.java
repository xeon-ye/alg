...
public class PlanRw {
    ...
    public static void CreateTables(String dbFile) {
        ...
        StringBuilder initSql = new StringBuilder("CREATE TABLE " + TABLE_DATA_NAME + " (" + " busName     varchar(8) NOT NULL,");
        for (int i = 0; i < 95; i++) {
    ...
    public static void parseAndSave(String filePath, String dbFile) {
        ...
        for (int i = 0; i < keys.length; i++) {
            ...
            StringBuilder insertSql = new StringBuilder("insert into " + TABLE_DATA_NAME + " values('" + keys[i] + "',");
