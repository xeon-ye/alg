...
#ifndef __IPCudaSolverInterface_HPP__
#define __IPCudaSolverInterface_HPP__
...
namespace Ipopt
{
  ...
  */
  class CudaSolverInterface: public SparseSymLinearSolverInterface
  {
  public:
  ...
  private:
    ...
    * they will not be implicitly created/called. */
    //@{
    /** Copy Constructor */
    CudaSolverInterface(const CudaSolverInterface&);

    /** Overloaded Equals Operator */
    void operator=(const CudaSolverInterface&);
    //@}
    ...
    void Solve2(int m, int n, int nnz, double *a, int *asub, int *xa, double *b, double *X);

    void Qsort(int *sort_array, int *position, double *a, int low, int high);

    void Qsort2(int *sort_array1, int *sort_array2, double *a, int low, int high);
