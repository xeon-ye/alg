...
#ifndef __IPCustomSolverInterface_HPP__
#define __IPCustomSolverInterface_HPP__
...
namespace Ipopt
{
  ...
  */
  class CustomSolverInterface: public SparseSymLinearSolverInterface
  {
  public:
    /** @name Constructor/Destructor */
    //@{
    /** Constructor */
    CustomSolverInterface();

    /** Destructor */
    virtual ~CustomSolverInterface();
    //@}
  ...
  private:
    ...
    * they will not be implicitly created/called. */
    //@{
    /** Copy Constructor */
    CustomSolverInterface(const CustomSolverInterface&);

    /** Overloaded Equals Operator */
    void operator=(const CustomSolverInterface&);
    //@}
