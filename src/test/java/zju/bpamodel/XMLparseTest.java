...
//        BpaPfModelRw.parseAndSave(inputPfPath, dbFile);
    ...
    public void testDoPf() {
        ...
        ExePlan.doPf(dbFile, psId, caseId, inputPfPath, outputPfPath, cmdPath, pfntFile, pfoFilePath);
    }
    ...
    public void testDoSw() {
        ...
        ExePlan.doSw(dbFile, psId, caseId, inputPfPath, outputPfPath, cmdPath, pfntFile, swntFile, bseFile, swiFilePath, outFilePath, swxFilePath);
    }
}